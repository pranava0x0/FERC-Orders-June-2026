...
window.FERC_DATA = (function () {
  ...
  const comments = {
    ...
    docsInventoried: 273, filesTotal: 279, attachments: 7, summarized: 9,
    note: "All 423 docket filings scraped from FERC eLibrary on 2026-06-24, and the document/attachment inventory pulled for all 273 comments (279 files, 7 with sub-documents). Stakeholder buckets are keyword-derived and the per-camp notes are a provisional read; the flagship comments below were downloaded and read in full. Audit trail saved under sources/comments/.",
    buckets: [
